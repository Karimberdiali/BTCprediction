...
GITHUB_LINK = os.environ.get(
    "GITHUB_LINK",
    "https://github.com/alikhanmin/BTCprediction",
)
...
fig = go.Figure(go.Line(x = np.arange(0,100), y = y))
    ...
    [
                        ...
                        html.Div(
                            [
                                html.Div(
                                    [
                                        html.Img(
                                            src=app.get_asset_url("btc.png")
                                        ),
                                        html.H4("Bitcoin price prediction"),
                                    ],
                                ...
                                html.Div(
                                    [
                                        html.P(
                                            "Hover over the chart to get the price of Bitcoin for exact date"
                                        )
                                    ],
        ...
        html.Div(
            [
                ...
                html.Div(
                    [
                        html.Span("Click on point in graph", className="subheader"),
                        html.Span("  |  "),
                        html.Span(
                            "It shows the price of bitcoin in a chosen point", className="small-text"
                        ),
                        dcc.Loading(
                ...
                html.Div(
                    [
                        html.Span("Choose date range", className="subheader"),
                        html.Span("  |  "),
                        html.Span(
                            "Graph chages depending on your input date",
                ...
                html.Div(
                    [
                        html.Span("Quick info", className="subheader"),
                        dcc.Loading(
                            html.Pre(id="click2-data",  children = ['This website is'],className="info__container"),
                            type="dot",
                        ),
                    ],
                    className="pb-20",
                ...
                html.Div(
                    [
                        html.Span("Authors:", className="subheader"),
                        dcc.Loading(
                            html.Pre(id="click3-data",  children = ['--Alixan Minturganov\n--Aziza Rakhmonkulova\n--Bekzod Bekzodov\n--O\'rozali Karimberdiyev'],className="info__container"),
                            type="dot",
                        ),
                    ],
                    className="pb-20",
...
def display_click_data(click_data):
    x_ = click_data['points'][0]['x']
    y_ = click_data['points'][0]['y']
    click_data = {'Chosen date': x_, 'Bitcoin price' : y_}
